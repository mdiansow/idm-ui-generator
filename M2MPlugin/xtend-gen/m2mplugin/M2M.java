...
public class M2M {
  ...
  public PollSystem loadPivotMM(final URI uri) {
    PollSystem _xblockexpression = null;
    {
      PivotMMDslStandaloneSetupGenerated _pivotMMDslStandaloneSetupGenerated = new PivotMMDslStandaloneSetupGenerated();
      _pivotMMDslStandaloneSetupGenerated.createInjectorAndDoEMFRegistration();
      ResourceSetImpl _resourceSetImpl = new ResourceSetImpl();
      Resource res = _resourceSetImpl.getResource(uri, true);
      EList<EObject> _contents = res.getContents();
      EObject _get = _contents.get(0);
  ...
  public void loadTest() {
    try {
            ...
            public void accept(final Option opt) {
              ...
              final Consumer<String> _function = new Consumer<String>() {
                public void accept(final String text) {
                  ...
                  String _value = cssValue.getValue();
                  final fr.istic.idm.pivotMM.Widget widgetType = M2M.this.getWidgetType(_value, model);
                  Assert.assertNotNull(widgetType);
                  widgetType.setValue(text);
                  EList<fr.istic.idm.pivotMM.Widget> _widgets = uimodel.getWidgets();
      ...
      URI _createURI_3 = URI.createURI("./Model.xmi");
      PollSystem pollS = this.loadPivotMM(_createURI_3);
      String _title = pollS.getTitle();
      String _plus = ("Title\t" + _title);
      InputOutput.<String>println(_plus);
      final GenerateUI html = new GenerateUI();
      final CharSequence file = html.toHtml(pollS);
  ...
  public fr.istic.idm.pivotMM.Widget getWidgetType(final String name, final PivotMMFactory pivot) {
