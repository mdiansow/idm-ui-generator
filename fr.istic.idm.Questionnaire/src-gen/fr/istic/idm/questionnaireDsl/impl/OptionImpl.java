 ...
 * <ul>
 *   <li>{@link fr.istic.idm.questionnaireDsl.impl.OptionImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OptionImpl extends MinimalEObjectImpl.Container implements Option
{
  ...
  {
    return QuestionnaireDslPackage.Literals.OPTION;
  }
  ...
  public EList<String> getText()
  {
    if (text == null)
    {
      text = new EDataTypeEList<String>(String.class, this, QuestionnaireDslPackage.OPTION__TEXT);
    }
    return text;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case QuestionnaireDslPackage.OPTION__TEXT:
        return getText();
    }
