 ...
 * <ul>
 *   <li>{@link fr.istic.idm.pivotMM.impl.WidgetImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WidgetImpl extends MinimalEObjectImpl.Container implements Widget
{
  ...
  {
    return PivotMMPackage.Literals.WIDGET;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PivotMMPackage.WIDGET__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PivotMMPackage.WIDGET__VALUE:
        return getValue();
    }
